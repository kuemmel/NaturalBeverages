//Das JDBC-Servlet "TelDBServletSelect.java"
...
public class TelDBServletSelect extends HttpServlet
{
       ...
       throws ServletException, IOException
   {
	 ...
	 //Dynamisch eingegebene Daten
         ...
         out.println("<body bgcolor=\"#CCCCFF\">TelDBServletDelete<hr>");
         ...
         ResultSet rs = st.executeQuery("select * from tel where name like '"+telname+"%' ");
         ...
         if(ideletecount==0)
         {
             out.println("<br>Could not find any tuples with name beginning with = "+telname);
         }
